...
public class ParentEventReview extends Review {
     ...
     * @param verified 
     */
    public ParentEventReview(Integer baseID, User user, Integer rating, Date date, String body,
            Boolean verified) 
    {
     ...
     * @param verified 
     */
    public ParentEventReview(User user, Integer rating, Date date, String body,
            Boolean verified) 
    {
